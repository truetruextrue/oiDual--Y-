...
(() => {
  ...
  injectStyle('kob-unified-style', `
    ...
    .symbol-bar[data-keep-inside="true"] {
  ...
  function initSymbolBarDrag() {
    ...
    bars.forEach((bar) => {
      ...
      function onPointerDown(e) {
        ...
        bar.addEventListener('pointermove', moveHandler, { passive: false });
