(function(){
  ...
  const PRESETS = [
    ...
    { key:'bg-fake-custom', label:'78F BG' },
  ...
  if (!localStorage.getItem('__baulite_seeded__')) {
    localStorage.setItem('infodose:userName','di_userName','KODUX');
    localStorage.setItem('infodose:assistantName','di_infodoseName','dualInfodose');
